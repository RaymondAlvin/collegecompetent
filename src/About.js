        ...
        <div className="container head2" style={{fontFamily: "STIX Two Text, sans-serif"}}>
            <div className="row">
                ...
                <div className="col" style={{textAlign: 'center'}}>
                    ...
                    <p style={{textAlign: 'center'}}>Biochemistry at UCLA </p><br></br>
                    <p style={{textAlign: 'left'}}>Nathan is an exceptional individual with a passion for science, community engagement, and academic excellence. As Nathan begins their journey at UCLA to pursue a Bachelor's degree in Biochemistry, their commitment to scientific exploration shines through. In addition to their academic pursuits, Nathan has made a significant impact as a Gymnasium and Parkour Coach, mentoring others in physical fitness and personal growth. Nathan's dedication to community service is evident through their role as a Community Leader for over four years at Team Michelle Non-Profit Organization. Their exceptional achievements and well-rounded profile led to admission offers from prestigious institutions such as Cal Berkeley, UCSD, UCSB, UCI, and Reed College, further highlighting Nathan's academic prowess and potential. Nathan's passion for science, leadership abilities, and commitment to community service make them an invaluable addition to any academic institution.
</p>
                </div>
            </div>
        </div>
