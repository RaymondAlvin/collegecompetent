  ...
  return (
    <div >
        ...
        <div className="container head1">
            <div className="row">
                <div className="col">
                    <img src={require('../src/images/essaypic.jpg')}  style={{ width: '400px', height: '300px' }} />
                ...
                <div className="col">
                    <img src={require('../src/images/harvardpic.jpg')}  style={{ width: '400px', height: '300px' }} />
                ...
                <div className="col">
                    <img src={require('../src/images/footballpic.jpg')}  style={{ width: '400px', height: '300px' }} />
